...
DESTINOS = {
    ...
    "olon": "https://www.kayak.com.ec/hotels/Olon,Ecuador-p2637203/2026-07-02/2026-07-31/2adults;map?ucs=e1vrmg&sort=rank_a",
...
def guardar(data, destino):
    ...
    file = f"data/raw/kayak_{destino}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
